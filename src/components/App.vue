...
<div class="newPost">
    <h1>Відділення Нової Пошти</h1>
        <select class="select" v-model="areas" v-on:change="chooseCity">
        ...
        <br>
        <select class="select" v-model="cities" v-on:change="chooseDepert" v-if="allCity[0]">
        ...
        <br>
        <select class="select" v-model="departs" v-if="allDepart[0]">
